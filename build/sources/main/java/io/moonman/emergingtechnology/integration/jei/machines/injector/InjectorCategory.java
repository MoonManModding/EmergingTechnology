...
public class InjectorCategory implements IRecipeCategory<InjectorRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/injectorgui.png");
    ...
    public String getUid() {
        return MachineReference.INJECTOR_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, InjectorRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
