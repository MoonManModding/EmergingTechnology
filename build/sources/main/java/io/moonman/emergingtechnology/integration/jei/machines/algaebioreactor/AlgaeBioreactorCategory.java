package io.moonman.emergingtechnology.integration.jei.machines.algaebioreactor;
...
public class AlgaeBioreactorCategory implements IRecipeCategory<AlgaeBioreactorRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/algaebioreactorgui.png");
    ...
    public String getUid() {
        return MachineReference.ALGAEBIOREACTOR_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, AlgaeBioreactorRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
