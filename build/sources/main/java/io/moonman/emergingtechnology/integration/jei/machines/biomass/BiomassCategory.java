...
public class BiomassCategory implements IRecipeCategory<BiomassRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/biomassgui.png");
    ...
    public BiomassCategory(IGuiHelper guiHelper) {
        background = guiHelper.createDrawable(TEXTURE, 0, 0, xSize, ySize);
        localizedName = MachineReference.BIOMASS_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.BIOMASS_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, BiomassRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
