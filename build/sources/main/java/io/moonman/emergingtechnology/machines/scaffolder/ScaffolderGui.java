...
public class ScaffolderGui extends GuiContainer {
	private static final ResourceLocation TEXTURES = new ResourceLocation(
			EmergingTechnology.MODID + ":textures/gui/scaffoldergui.png");
	private final InventoryPlayer player;
	private final ScaffolderTileEntity tileEntity;

	private String NAME = ModBlocks.scaffolder.getLocalizedName();
