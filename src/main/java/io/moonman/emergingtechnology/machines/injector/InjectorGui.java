...
public class InjectorGui extends GuiContainer {
	...
	private int getEnergyScaled(int scaled) {
		return (int) (tileEntity.getField(0) * scaled / Reference.INJECTOR_ENERGY_CAPACITY);
	}

	private int getFluidScaled(int scaled) {
		return (int) (tileEntity.getField(1) * scaled / Reference.INJECTOR_FLUID_CAPACITY);
	}
	...
	private void renderTooltips(int mouseX, int mouseY) {
		...
		int nutrient = this.tileEntity.getField(3);
