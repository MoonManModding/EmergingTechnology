...
public class Speaker extends SimpleMachineBase implements ITileEntityProvider {

    public static final PropertyDirection FACING = PropertyDirection.create("facing");

    public Speaker() {
        super(Material.IRON, "speaker");
	...
	public int getWeakPower(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing side) {
        ...
        if (tile instanceof SpeakerTileEntity) {
            SpeakerTileEntity speaker = (SpeakerTileEntity) tile;

            return speaker.getIsPowered() ? 30 : 0;
        }
    ...
    public void addInformation(ItemStack stack, World player, List<String> tooltip, ITooltipFlag advanced) {
        ...
        if (KeyBindings.showExtendedTooltips()) {
            tooltip.add(Lang.get(Lang.SPEAKER_DESC));
        } else {
