...
public class ScaffolderCategory implements IRecipeCategory<ScaffolderRecipeWrapper> {
    ...
    public String getUid() {
        return MachineReference.SCAFFOLDER_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, ScaffolderRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
