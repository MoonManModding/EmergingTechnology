...
public class OptimiserCategory implements IRecipeCategory<OptimiserRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/optimisergui.png");
    ...
    public OptimiserCategory(IGuiHelper guiHelper) {
        background = guiHelper.createDrawable(TEXTURE, 0, 0, xSize, ySize);
        localizedName = MachineReference.OPTIMISER_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.OPTIMISER_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, OptimiserRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
