...
public class CookerCategory implements IRecipeCategory<CookerRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/cookergui.png");
    ...
    public String getUid() {
        return MachineReference.COOKER_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, CookerRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
