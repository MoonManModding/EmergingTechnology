...
public class HydroponicCategory implements IRecipeCategory<HydroponicRecipeWrapper> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/hydroponicgui.png");
    ...
    public HydroponicCategory(IGuiHelper guiHelper) {
        background = guiHelper.createDrawable(TEXTURE, 0, 0, xSize, ySize);
        localizedName = MachineReference.HYDROPONIC_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.HYDROPONIC_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, HydroponicRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
