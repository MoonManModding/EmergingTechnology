...
public class DiffuserCategory implements IRecipeCategory<DiffuserRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/diffusergui.png");
    ...
    public DiffuserCategory(IGuiHelper guiHelper) {
        background = guiHelper.createDrawable(TEXTURE, 0, 0, xSize, ySize);
        localizedName = MachineReference.DIFFUSER_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.DIFFUSER_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, DiffuserRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
