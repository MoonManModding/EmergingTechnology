...
public class LightCategory implements IRecipeCategory<LightRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/lightgui.png");
    ...
    public LightCategory(IGuiHelper guiHelper) {
        background = guiHelper.createDrawable(TEXTURE, 0, 0, xSize, ySize);
        localizedName = MachineReference.LIGHT_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.LIGHT_UID;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, LightRecipeWrapper recipeWrapper, IIngredients ingredients)
    {
