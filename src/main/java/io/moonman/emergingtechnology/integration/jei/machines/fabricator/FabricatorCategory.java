...
public class FabricatorCategory implements IRecipeCategory<FabricatorRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/fabricatorgui.png");
    ...
    public FabricatorCategory(IGuiHelper guiHelper) {
        ...
        localizedName = MachineReference.FABRICATOR_NAME;
    }

    @Nonnull
    @Override
    public String getUid() {
        return MachineReference.FABRICATOR_UID;
    }
