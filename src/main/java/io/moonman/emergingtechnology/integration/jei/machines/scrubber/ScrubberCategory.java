package io.moonman.emergingtechnology.integration.jei.machines.scrubber;
...
public class ScrubberCategory implements IRecipeCategory<ScrubberRecipeWrapper> {

    public static final ResourceLocation TEXTURE = new ResourceLocation(
        EmergingTechnology.MODID + ":textures/jei/scrubbergui.png");
    ...
    public String getUid() {
        return MachineReference.SCRUBBER_UID;
    }
