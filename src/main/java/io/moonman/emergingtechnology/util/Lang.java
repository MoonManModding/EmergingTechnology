...
public class Lang {
        ...
        public static final TextComponentTranslation BIOMASS_DESC = new TextComponentTranslation(
                        SOURCE + "biomass" + DESC);
        ...
        public static final TextComponentTranslation COOKER_DESC = new TextComponentTranslation(
                        SOURCE + "cooker" + DESC);
        public static final TextComponentTranslation FABRICATOR_DESC = new TextComponentTranslation(
                        SOURCE + "fabricator" + DESC);
        public static final TextComponentTranslation FILLER_DESC = new TextComponentTranslation(
                        SOURCE + "filler" + DESC);
        public static final TextComponentTranslation INJECTOR_DESC = new TextComponentTranslation(
                        SOURCE + "injector" + DESC);
        public static final TextComponentTranslation ALGAEBIOREACTOR_DESC = new TextComponentTranslation(
                        SOURCE + "algaebioreactor" + DESC);
        ...
        public static final TextComponentTranslation SOLARGLASS_DESC = new TextComponentTranslation(
                        SOURCE + "solarglass" + DESC);
        ...
        public static final TextComponentTranslation BULB_DESC = new TextComponentTranslation(
                        SOURCE + "bulb.description");
        ...
        public static final TextComponentTranslation GUI_BOOST = new TextComponentTranslation(
                        GUI_SOURCE + "label.boost");
        ...
        public static final TextComponentTranslation GUI_GROWTH = new TextComponentTranslation(
                        GUI_SOURCE + "label.growth");
        ...
        public static final TextComponentTranslation GUI_ERROR = new TextComponentTranslation(
                        GUI_SOURCE + "label.error");
        ...
        public static String getLongNozzleDescription() {
                return new TextComponentTranslation(SOURCE + "nozzlelong.description",
                                EmergingTechnologyConfig.HYDROPONICS_MODULE.DIFFUSER.LONG.rangeMultiplier)
                                                .getFormattedText();
        }

        public static String getPreciseNozzleDescription() {
                return new TextComponentTranslation(SOURCE + "nozzleprecise.description",
                                EmergingTechnologyConfig.HYDROPONICS_MODULE.DIFFUSER.PRECISE.boostMultiplier)
                                                .getFormattedText();
        }
